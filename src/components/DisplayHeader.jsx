...
import codeforces_Logo from "../assets/codeforces.svg"
...
export default function DisplayPicture({img_url=pfp}){
  ...
  let codeforcesId = "https://codeforces.com/profile/vedanttapkir"
  let leetcodeId = "https://leetcode.com/u/VedantTapkir/"
    return (
        ...
        <div className="contact">
          ...
          <a href={codeforcesId}><img src={codeforces_Logo} /></a>
          <a href={leetcodeId}><img src={leetcode_Logo} /></a>
